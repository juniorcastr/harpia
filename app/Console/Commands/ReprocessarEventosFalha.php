...
class ReprocessarEventosFalha extends Command
{
    ...
    protected $description = 'Reprocessa eventos de acesso que falharam por causa transitória, como vinculação pendente';
    ...
    public function handle()
    {
        ...
        $eventos = $this->eventoRepository->buscarFalhasParaReprocessamento($limite);
        $reprocessados = 0;
        $mantidos = 0;
        ...
        $this->info(sprintf(
            'Reprocessamento concluído: %d reprocessados, %d mantidos em erro.',
            $reprocessados,
            $mantidos
        ));
    }
