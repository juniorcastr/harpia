<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('mtc_data_inicio')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="mtc_data_inicio" value="{{ old('mtc_data_inicio', $colaborador->mtc_data_inicio ?? '') }}" class="form-control datepicker" data-provide="datepicker" date-date-format="dd/mm/yyyy" >
