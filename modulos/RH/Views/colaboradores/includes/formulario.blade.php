<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('col_data_admissao')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="col_data_admissao" value="{{ old('col_data_admissao', $colaborador->col_data_admissao ?? '') }}" class="form-control datepicker" data-provide="datepicker" date-date-format="dd/mm/yyyy" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('col_ch_diaria')) has-error @endif">
        ...
        <div class="controls">
            <input type="number" name="col_ch_diaria" value="{{ old('col_ch_diaria', $colaborador->col_ch_diaria ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('col_codigo_catraca')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="col_codigo_catraca" value="{{ old('col_codigo_catraca', $colaborador->col_codigo_catraca ?? '') }}" class="form-control" >
...
<div class="row">
    ...
    @foreach(array('0' => 'Não', '1' => 'Sim') as $key => $value)
        <option value="{{ $key }}" {{ old('col_vinculo_universidade', $colaborador->col_vinculo_universidade ?? '') == $key ? 'selected' : '' }}>{{ $value }}</option>
    @endforeach
</select>
    ...
    <div class="form-group col-md-4 @if ($errors->has('col_matricula_universidade')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="col_matricula_universidade" value="{{ old('col_matricula_universidade', $colaborador->col_matricula_universidade ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('col_qtd_filho')) has-error @endif">
        ...
        <div class="controls">
            <input type="number" name="col_qtd_filho" value="{{ old('col_qtd_filho', $colaborador->col_qtd_filho ?? '') }}" class="form-control" >
...
<div class="row">
    <div class="form-group col-md-12 @if ($errors->has('col_observacao')) has-error @endif">
        ...
        <div class="controls">
            <textarea name="col_observacao" class="form-control" rows="3">{{ old('col_observacao', $colaborador->col_observacao ?? '') }}</textarea>
