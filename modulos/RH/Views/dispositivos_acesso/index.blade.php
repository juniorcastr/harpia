...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form method="GET" action="{{ route('rh.dispositivos-acesso.index') }}">
                <div class="row">
                    <div class="col-md-4">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <a href="{{ route('rh.dispositivos-acesso.create') }}" class="btn btn-success">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    @foreach($dispositivos as $dispositivo)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('rh.dispositivos-acesso.edit', ['id' => $dispositivo->dis_id]) }}" class="btn btn-xs btn-primary">
                                    <i class="fa fa-pencil"></i> Editar
                                </a>

                                <form method="POST" action="{{ route('rh.dispositivos-acesso.ping', ['id' => $dispositivo->dis_id]) }}" style="display: inline;">
                                    {{ csrf_field() }}
                                ...
                                <form method="POST" action="{{ route('rh.dispositivos-acesso.sincronizar-mapeamento', ['id' => $dispositivo->dis_id]) }}" style="display: inline;">
                                    {{ csrf_field() }}
                                ...
                                <form method="POST" action="{{ route('rh.dispositivos-acesso.delete') }}" style="display: inline;">
                                    {{ csrf_field() }}
