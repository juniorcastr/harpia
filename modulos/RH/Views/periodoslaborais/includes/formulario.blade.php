<div class="row">
    <div class="form-group col-md-6 @if ($errors->has('pel_inicio')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="pel_inicio" value="{{ old('pel_inicio', $periodolaboral->pel_inicio ?? '') }}" class="form-control datepicker" data-provide="datepicker" date-date-format="dd/mm/yyyy" >
    ...
    <div class="form-group col-md-6 @if ($errors->has('pel_termino')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="pel_termino" value="{{ old('pel_termino', $periodolaboral->pel_termino ?? '') }}" class="form-control datepicker" data-provide="datepicker" date-date-format="dd/mm/yyyy" >
