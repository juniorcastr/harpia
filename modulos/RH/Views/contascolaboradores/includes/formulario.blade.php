<div class="row">
    ...
    @foreach($bancos as $key => $value)
        <option value="{{ $key }}" {{ old('ccb_ban_id', $conta_colaborador->ccb_ban_id ?? '') == $key ? 'selected' : '' }}>{{ $value }}</option>
    @endforeach
</select>
    ...
    <div class="form-group col-md-3 @if ($errors->has('ccb_agencia')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="ccb_agencia" value="{{ old('ccb_agencia', $conta_colaborador->ccb_agencia ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-3 @if ($errors->has('ccb_conta')) has-error @endif">
      ...
      <div class="controls">
                <input type="text" name="ccb_conta" value="{{ old('ccb_conta', $conta_colaborador->ccb_conta ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-3 @if ($errors->has('ccb_variacao')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="ccb_variacao" value="{{ old('ccb_variacao', $conta_colaborador->ccb_variacao ?? '') }}" class="form-control" >
