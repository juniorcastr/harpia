    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box box-info">
                ...
                <div class="box-footer">
                    <a href="{{ route('rh.dispositivo-usuarios.index', ['dis_id' => $dispositivo->dis_id]) }}" class="btn btn-default btn-block">
        ...
        <div class="col-md-8">
            <div class="box box-primary">
                ...
                <form method="POST" action="{{ route('rh.dispositivo-usuarios.edit', ['id' => $usuario['user_id']]) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <form method="POST" action="{{ route('rh.dispositivo-usuarios.atualizar-foto', ['id' => $usuario['user_id']]) }}" enctype="multipart/form-data" style="margin-bottom: 10px;">
                        {{ csrf_field() }}
                        <input type="hidden" name="dis_id" value="{{ $dispositivo->dis_id }}">
                    ...
                    <form method="POST" action="{{ route('rh.dispositivo-usuarios.remover-foto', ['id' => $usuario['user_id']]) }}">
                        {{ csrf_field() }}
                        <input type="hidden" name="dis_id" value="{{ $dispositivo->dis_id }}">
