...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form method="GET" action="{{ route('rh.dispositivo-usuarios.index') }}">
                <div class="row">
                    <div class="col-md-10">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form method="POST" action="{{ route('rh.dispositivo-usuarios.create') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <form method="POST" action="{{ route('rh.dispositivo-usuarios.sincronizar') }}" style="margin-bottom: 10px;">
                            {{ csrf_field() }}
                            <input type="hidden" name="dis_id" value="{{ $dispositivo->dis_id }}">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                @foreach($usuarios as $usuario)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('rh.dispositivo-usuarios.edit', ['id' => $usuario['user_id'], 'dis_id' => $dispositivo->dis_id]) }}" class="btn btn-xs btn-primary">
                                                <i class="fa fa-pencil"></i> Editar
                                            </a>

                                            <form method="POST" action="{{ route('rh.dispositivo-usuarios.delete') }}" style="display: inline;">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="dis_id" value="{{ $dispositivo->dis_id }}">
                                                <input type="hidden" name="user_id" value="{{ $usuario['user_id'] }}">
                                                <button type="submit" class="btn btn-xs btn-danger" onclick="return confirm('Tem certeza que deseja remover o usuário do dispositivo?')">
